...
var FormactMe = function (_Component) {
  ...
  function FormactMe(props, context) {
    ...
    var value = props.value || props.defaultValue || null;

    _this.state = {
      value: value,
      errorMessage: _this.validate(value),
      dirty: false
    };
    return _this;
  }
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.propagateValue = function (value) {
    if (_this2.context && _this2.context.valueChanged) {
      _this2.context.valueChanged(_this2.props.name, value);
      _this2.setState({
        value: value,
        errorMessage: _this2.validate(value)
      });
    }
  };

  this.onChange = function (value) {
    _this2.propagateValue(value);
  ...
  this.validate = function (proposedValue) {
    var value = proposedValue || _this2.state && _this2.state.value;
    ...
    errorMessage = validation.map(function (fun) {
      return fun(value, _this2.props.name);
    }).filter(function (m) {
      return m;
    }).join(' ');
