...
function useFormReducer(initialState = {}, initialValues = {}, onChange) {
    const reducer = (0, react_1.useCallback)(createReducer(), []);
    const [state, action] = (0, react_1.useReducer)(reducer, Object.assign({ validations: {}, errors: {}, dirty: {}, forcedErrors: {}, values: initialValues, valid: true }, initialState));
...
function Form(props) {
    const reducer = useFormReducer(props.initialState, props.initialValues, props.onChange);
